...
```ts
  ...
  6  |     //locators
  7  |     private readonly InkMyAccount: Locator;
  8  |     private readonly InkRegister: Locator;
  ...
  15 |         this.page = page;
  16 |         //this.InkMyAccount = page.locator('span : has-text("My Account")');
  17 |         this.InkRegister = page.locator('a:has-text("Register")');
  ...
  35 |         try {
> 36 |             await this.InkMyAccount.click();
     |                                     ^ TypeError: Cannot read properties of undefined (reading 'click')
  37 |         } catch (error) {
  ...
  43 |         try{
  44 |             await this.InkRegister.click();
  45 |         }catch (error){
